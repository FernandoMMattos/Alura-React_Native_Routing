...
const pets = [
  {
    ...
    descricao: {
      informacoes: [
        ...
        "Se dá bem com crianças mais velhas mas se assusta com bebes",
        "Gosta de brincar e passear",
      ],
      resumo:
        "Dunga é encantador, conquista a todos com sua serenidade. Tem pelo macio e olhos expressivos que revelam a doçura de sua personalidade. Adora passar o tempo relaxando ao lado de seus humanos ou em um cantinho ensolarado. Este companheiro leal e afetuoso vai trazer uma atmosfera alegre para qualquer lar que tenha a sorte de tê-lo como parte da família!",
      fotos: [dunga1, dunga2],
    },
  },
  {
  ...
  },
  {
    ...
    descricao: {
      informacoes: ["Se dá bem com outros gatos", "Gosta de dormir e brincar"],
      resumo:
        "Sirius é um cachorro muito carinhoso e brincalhão. Ele é muito companheiro e vai fazer muita companhia para a família que adotá-la.",
  ...
  },
  {
    ...
    descricao: {
      informacoes: ["Se dá bem com outros gatos", "Gosta de dormir e brincar"],
      resumo:
        "Fiona é uma cachorra muito carinhosa e brincalhona. Ela é muito companheira e vai fazer muita companhia para a família que adotá-la.",
      fotos: [fiona1, fiona2],
    },
  },
];
